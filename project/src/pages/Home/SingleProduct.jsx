    ...
    <div className="max-w-screen-2xl container mx-auto mt-28  xl:px-28 px-4">
              ...
              <div className="grid gird-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-6 h-max">
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    ...
                    {/* Product Price */}
                    <span className="text-xl text-Brand font-semibold sm:text-2xl">
                      ${price}
                    </span>
                  </div>
      ...
      <div className="mt-5">
        ...
        <div className="mt-4 space-y-4">
          <li className="text-sm text-TextColor">{demoText.highlights[0]}</li>
          <li className="text-sm text-TextColor">{demoText.highlights[1]}</li>
          <li className="text-sm text-TextColor">{demoText.highlights[2]}</li>
          <li className="text-sm text-TextColor">{demoText.highlights[3]}</li>
        </div>
      </div>
    </div>
  );
