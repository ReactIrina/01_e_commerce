...
// import { AiOutlineHeart, AiFillHeart } from "react-icons/ai"; // Import outlined and filled heart icons
...
//                   >
//                     {likedItems[item.id] ? (
//                       <AiFillHeart className="text-yellow-500" /> // Full yellow heart when liked
//                     ) : (
//                       <AiOutlineHeart /> // Outlined heart when not liked
//                     )}
//                   </div>
//                 </div>
//                 <div className="flex pt-4 pb-4 pr-4">
